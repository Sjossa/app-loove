export class Profil {
  ...
  displayUser(user) {
    ...
    if (this.profile_picture) this.profile_picture.src = user.profile_picture || "chemin/par-defaut.jpg";
    if (this.status) this.status.value = user.statut || '';
    if (this.orientation) this.orientation.value = user.orientation || '';
    if (this.relation_recherchee) this.relation_recherchee.value = user.relation_recherchee || '';
